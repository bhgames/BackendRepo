...
public class BQ1 extends QuestListener {
	...
	public String[] getCurrentQuestText(int pid) {
		String[] additional  = { "5 Knowledge Points" },
				toRet = {"<div class='goalBox'>Goals:<ul><li>Queue 5 Engineers</li></ul></div><div class='descBox'>Hello and Welcome to Steampunk Wars! If this is your first time playing, I encourage you to watch the Tutorial, if you haven't already. This can be accessed via the Menu if you skipped it.<br/><br/>" +
