	...
	public String[] getCurrentQuestText(int pid) {
		...
		String toRet[] = {/*"Prompt:<br /><br />"+
			"‘What the hell were those things?’ you shout, pushing yourself off the ground and brushing off bits of broken glass and debris. An Iddite nearly got to your control tower but you managed to hold him off.<br /><br />"+
					...
					"<br />It's time to fight back! As you've been told, Id towns, while home to dangerous zombie-like foes called Iddites, are also some of the largest resource and technology depots in the A.I. Wars Universe!<br /><br />Before you can attack an Id town, you'll need a Headquarters from which to direct your troops. Then you can send attacks to any Id city on the World Map! If you are unsure how to send attacks, you can always press the ? button on the World Map.<br /><br />Goal: Build a Headquarters and successfully attack and pillage one of Id's cities.<br /><br />" + getRewardBlock(2,pid,additional) ,"No hint."};
