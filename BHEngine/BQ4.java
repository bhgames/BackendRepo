...
public class BQ4 extends QuestListener {
	...
	public String[] getCurrentQuestText(int pid) {
		...
		String toRet[] = {"<div class='goalBox'>Goals:<ul><li>Attack a nearby town</li></ul></div><div class='descBox'>" +
				"Excellent! To speed things up a bit, your remaining 4 queued soldiers have been finished automatically.<br/><br/>" +
				...
				"Send the attack now. You'll receive your next task when the attack lands.</div><div class='rewardBox'>" + getRewardBlock(0,pid,additional)+"</div>" ,"No hint."};
