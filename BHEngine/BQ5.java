...
public class BQ5 extends QuestListener {
	...
	public String[] getCurrentQuestText(int pid) {
		String additional[] = {};
		String toRet[] = {"<div class='goalBox'>Goals:<ul><li>Research a Technology</li></ul></div><div class='descBox'>" +
				"Congratulations! You've liberated some resources. Attacking, or 'Farming', Id towns is a good way to earn resources while you're starting out.<br/><br/>" +
				...
				"Once you've found a tech you like, and can afford, research it.</div><div class='rewardBox'>"+getRewardBlock(1,pid,additional)+"</div>","No hint."
		};
		return toRet;
	}
